...
| 002 | Currículos e otimização com IA | 🚧 Loop principal ligado no backend real e testado ao vivo (create/edit/delete/otimizar); falta import de PDF | [log.md](002-resume-optimization/log.md) |
