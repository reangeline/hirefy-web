...
| 013 | Otimização de currículo/ATS grátis pra qualquer cadastrado (muda modelo de monetização da spec 007) — toca também `backend_hirefy` | 📝 Investigação concluída, spec escrita; implementação não iniciada | [spec.md](013-ats-gratuito-cadastro/spec.md) |
