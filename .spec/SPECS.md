...
| 002 | Currículos e otimização com IA | 🚧 Loop principal + import de PDF ligados no backend real e testados ao vivo; falta só testar o caminho de falha (crédito insuficiente) | [log.md](002-resume-optimization/log.md) |
...
| 005 | Pipeline de candidaturas (Kanban + Coach + Contatos + Analytics) | 📝 Em planejamento (spec escrita, nada implementado) | [log.md](005-pipeline-candidaturas/log.md) |
