...
| 012 | Prática de entrevista focada nos gaps reais da vaga (diferencial: ir além de conseguir a entrevista, ajudar a passar nela) — toca também `backend_hirefy` | 🚧 Implementado e deployado em dev (backend + web-app); corrigido de brinde um bug real (`resumeDataFor` buscava na tabela errada pra vaga já otimizada). Falta testar ao vivo | [spec.md](012-interview-prep-focado-em-gaps/spec.md) |
